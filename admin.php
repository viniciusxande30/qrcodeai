...
<?php
// Obtém o caminho físico do diretório atual (onde o arquivo PHP está localizado)
$rootPath = realpath(dirname(__FILE__));

// Remove a parte inicial do caminho absoluto até chegar à raiz do projeto
$projectRoot = str_replace($_SERVER['DOCUMENT_ROOT'], '', $rootPath);

// Obtém o URL completo do projeto
...
<body>
    <div class="container">
        <h1>Bem-vindo à Página Administrativa</h1>
        <a href="<?= $url; ?>/qrcodeai/login-system/logout.php" class="btn btn-danger">Logout</a>
    </div>
</body>
</html>
